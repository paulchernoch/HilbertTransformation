...
namespace HilbertTransformationTests.Data
{
    ...
    /// (<a href="http://www.dtic.mil/cgi-bin/GetTRDoc?AD=AD423993&Location=U2&doc=GetTRDoc.pdf">Article</a>)
    ...
    public class ZigguratGaussianSampler
    {
        ...
        /// </summary>
        const double __UIntToU = 1.0 / uint.MaxValue;
        ...
        public ZigguratGaussianSampler(FastRandom rng)
        {
            ...
            _xComp[0] = (uint)(((__R * _y[0]) / __A) * uint.MaxValue);
